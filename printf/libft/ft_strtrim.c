...
/*   Updated: 2019/10/25 13:30:39 by acharras    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
char	*ft_strcpy(char *str, char const *s1, size_t start, size_t end)
{
	int		i;
...
int		ft_check_char(char *set, char c)
{
	int		i;
...
int		ft_check_start(char *set, char *s1)
{
	int		i;
...
int		ft_check_end(char *set, char *s1)
{
	int		i;
